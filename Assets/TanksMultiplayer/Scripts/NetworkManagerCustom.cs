...
namespace TanksMP
{
	...
	public class NetworkManagerCustom : PunBehaviour
    {
        ...
        /// </summary>
        public static int onlineSceneIndex = 1;
		...
		void AddPlayer()
		{
            ...
            Vector3 startpos1 = new Vector3(2, 0, 2);
            if (startPos != null) PhotonNetwork.Instantiate(playerPrefabs[prefabId].name, startpos1, startPos.rotation, 0);
