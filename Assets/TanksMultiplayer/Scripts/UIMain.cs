...
namespace TanksMP
{
    ...
    public class UIMain : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (!PlayerPrefs.HasKey(PrefsKeys.Difficulty)) PlayerPrefs.SetInt(PrefsKeys.Difficulty, 20);
            PlayerPrefs.Save();
        ...
        public void Play(int level)
        {
            ...
            NetworkManagerCustom.onlineSceneIndex = level;
        ...
        {
            PlayerPrefs.SetInt(PrefsKeys.Difficulty, a);
        }
        /// <summary>
